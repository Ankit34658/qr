        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
            ...
            <main className="min-h-screen bg-gray-50 px-4 py-8">
                <div className="max-w-md mx-auto">
                    ...
                    {/* Control Room - Improved without number */}
                    <button
                        onClick={() => window.location.href = 'tel:8252472186'}
                        className="w-full bg-gradient-to-r from-red-500 to-red-600 text-white rounded-2xl p-4 mb-8 hover:shadow-xl hover:from-red-600 hover:to-red-700 active:scale-98 transition-all group"
                    >
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="w-12 h-12 bg-white/20 backdrop-blur text-white rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Phone size={24} className="animate-pulse" />
                                </div>
                                <div className="text-left">
                                    <p className="text-white/90 text-sm font-bold">Emergency Helpline</p>
                                    <p className="text-xs text-white/70">24/7 Control Room Support</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-2">
                                <span className="text-xs bg-white/20 px-2 py-1 rounded-lg font-semibold">CALL NOW</span>
